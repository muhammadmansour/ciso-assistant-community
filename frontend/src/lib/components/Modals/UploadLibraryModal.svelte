	...
	<div class="card bg-white p-4 mt-4 shadow-sm">
		...
		{:then form}
			...
			{#snippet children({ form, delayed })}
				...
				/>
				<button
					class="btn bg-gradient-to-r from-[#1e2a4a] to-[#243156] text-white hover:from-[#243156] hover:to-[#2a3a66] font-semibold w-full rounded-lg shadow-sm transition-all {delayed
