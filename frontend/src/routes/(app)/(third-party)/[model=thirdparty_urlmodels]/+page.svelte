					...
					<div>
						<span class="inline-flex overflow-hidden rounded-md border bg-white shadow-xs">
							{#if !['risk-matrices', 'frameworks', 'requirement-mapping-sets', 'user-groups', 'role-assignments'].includes(URLModel)}
								<button
									class="inline-block border-e p-3 text-gray-50 bg-[#1e2a4a] hover:bg-[#243156] w-12 focus:relative"
								...
								{#if ['applied-controls', 'assets'].includes(URLModel)}
									<a
										...
										class="inline-block p-3 text-gray-50 bg-[#1e2a4a] hover:bg-[#243156] w-12 focus:relative"
