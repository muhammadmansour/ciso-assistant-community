import"./Bzak7iHL.js";import"./69_IOA4Y.js";import{p as Oe,aX as pe,N as J,Q as L,ar as b,aY as ze,f as h,i as I,g as u,s as C,a as c,b as Be,c as f,r as g,t as U,a9 as X,aF as he,q as O,av as H}from"./stSixLta.js";import{s as be,e as fe}from"./DtatPURh.js";import{a as Re}from"./C4niOJRc.js";import{i as D}from"./B6ld54w6.js";import{h as K}from"./DxMLkaLG.js";import{s as We}from"./DzqOPh7h.js";import{s as z}from"./CEj1gugw.js";import{s as qe}from"./9qRfmEid.js";import{b as Je}from"./CFOraUKk.js";import{p as Le}from"./DnUyVyNy.js";import{i as He}from"./C5bWV7q4.js";import{p as l,a as ge,e as Ye,s as Pe}from"./BOnj4S0p.js";import{p as Ze}from"./DebWI5i8.js";import{r as ve,g as me}from"./CmKwYUow.js";/*! clipboard-copy. MIT License. Feross Aboukhadijeh <https://feross.org/opensource> */function $(){return new DOMException("The request is not allowed","NotAllowedError")}async function Ge(v){if(!navigator.clipboard)throw $();return navigator.clipboard.writeText(v)}async function Qe(v){const t=document.createElement("span");t.textContent=v,t.style.whiteSpace="pre",t.style.webkitUserSelect="auto",t.style.userSelect="all",document.body.appendChild(t);const n=window.getSelection(),B=window.document.createRange();n==null||n.removeAllRanges(),B.selectNode(t),n==null||n.addRange(B);let i=!1;try{i=window.document.execCommand("copy")}finally{n==null||n.removeAllRanges(),window.document.body.removeChild(t)}if(!i)throw $()}async function Ue(v){try{await Ge(v)}catch(t){try{await Qe(v)}catch(n){throw n||t||$()}}}var Xe=h(`<style>.super-debug--absolute {
			position: absolute;
		}
    ...
    `:void 0)}),pe(()=>(b(R()),b(y()),ve),()=>{Ye(J(re,ne(R(),y())?R():ve(R())),"$debugData",n)}),ze(),He();var ce=dr(),ie=I(ce);{var Se=o=>{var s=Xe();c(o,s)};D(ie,o=>{u(ye)||o(Se)})}var Ie=C(ie,2);{var Ce=o=>{var s=tr();let e;var r=f(s),_=f(r),q=f(_,!0);g(_);var k=C(_,2),m=f(k),De=f(m);{var Ee=d=>{var a=Ke();c(d,a)},je=d=>{var a=$e();c(d,a)};D(De,d=>{u(W)?d(je,!1):d(Ee)})}g(m);var Ae=C(m,2);{var Te=d=>{var a=er();let x;var N=f(a,!0);g(a),U(T=>{x=z(a,1,"",null,x,T),be(N,(i(),O(()=>i().status)))},[()=>({"super-debug--info":i().status<200,"super-debug--success":i().status>=200&&i().status<300,"super-debug--redirect":i().status>=300&&i().status<400,"super-debug--error":i().status>=400})],X),c(d,a)};D(Ae,d=>{_e()&&d(Te)})}g(k),g(r);var A=C(r,2);let le;var ue=f(A),Me=f(ue);We(Me,t,"default",{},d=>{var a=H(),x=I(a);{var N=S=>{var M=H(),G=I(M);Re(G,E,F=>{var p=or();c(F,p)},(F,p)=>{var V=H(),Q=I(V);K(Q,()=>(b(u(p)),b(y()),b(me),O(()=>Z(ne(u(p),y())?me(u(p)):u(p))))),c(F,V)},(F,p)=>{var V=rr(),Q=C(I(V),2);K(Q,()=>(b(u(p)),O(()=>Z(u(p))))),c(F,V)}),c(S,M)},T=S=>{var M=H(),G=I(M);K(G,()=>(E(),O(()=>Z(E())))),c(S,M)};D(x,S=>{E(),b(y()),b(se()),O(()=>Ne(E(),y(),se()))?S(N):S(T,!1)})}c(d,a)}),g(ue),g(A),Je(A,d=>oe(d),()=>oe());var Fe=C(A,2);{var Ve=d=>{var a=sr(),x=f(a);let N;g(a),U(T=>N=z(x,0,"",null,N,T),[()=>({"super-debug--rotated":w()})],X),fe("click",a,Le(()=>de(!w()))),c(d,a)};D(Fe,d=>{P()&&d(Ve)})}g(s),U((d,a)=>{e=z(s,1,"super-debug",null,e,d),qe(s,u(ee)),z(r,1,`super-debug--status ${Y()===""?"super-debug--absolute super-debug--inset-x-0 super-debug--top-0":""}`),be(q,Y()),le=z(A,1,"super-debug--pre",null,le,a),s.dir=s.dir},[()=>({"super-debug--collapsible":P()}),()=>({"super-debug--with-label":Y(),"super-debug--hidden":w()})],X),fe("click",m,xe),c(o,s)};D(Ie,o=>{we()&&o(Ce)})}c(v,ce),Be(),B()}export{kr as S};
