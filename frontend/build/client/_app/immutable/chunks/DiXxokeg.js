import"./Bzak7iHL.js";import"./69_IOA4Y.js";import{p as Oe,aV as pe,j as L,S as q,at as b,aW as We,f as h,i as I,g as u,s as C,b as c,c as ze,d as f,r as g,t as K,ab as Q,k as he,x as O,ax as H}from"./M_q2dmUf.js";import{s as be,e as fe}from"./YZ_AKCUg.js";import{a as Be}from"./yMkN5qD0.js";import{i as D}from"./BWMfAn3D.js";import{h as X}from"./ym4Iat4u.js";import{s as Re}from"./C8D69k2T.js";import{s as W}from"./JdlpyyE_.js";import{s as Je}from"./D9F1RVaI.js";import{b as Le}from"./DdTgDLj8.js";import{p as qe}from"./C_aSl-9I.js";import{i as He}from"./DZQfXi9Y.js";import{p as l,a as ge,e as Pe,s as Ye}from"./CkxhXx0K.js";import{p as Ze}from"./CbkoIhbq.js";import{r as ve,g as me}from"./Cyd4__q3.js";/*! clipboard-copy. MIT License. Feross Aboukhadijeh <https://feross.org/opensource> */function $(){return new DOMException("The request is not allowed","NotAllowedError")}async function Ge(v){if(!navigator.clipboard)throw $();return navigator.clipboard.writeText(v)}async function Ue(v){const t=document.createElement("span");t.textContent=v,t.style.whiteSpace="pre",t.style.webkitUserSelect="auto",t.style.userSelect="all",document.body.appendChild(t);const n=window.getSelection(),z=window.document.createRange();n==null||n.removeAllRanges(),z.selectNode(t),n==null||n.addRange(z);let i=!1;try{i=window.document.execCommand("copy")}finally{n==null||n.removeAllRanges(),window.document.body.removeChild(t)}if(!i)throw $()}async function Ke(v){try{await Ge(v)}catch(t){try{await Ue(v)}catch(n){throw n||t||$()}}}var Qe=h(`<style>.super-debug--absolute {
			position: absolute;
		}
    ...
    `:void 0)}),pe(()=>(b(B()),b(y()),ve),()=>{Pe(L(re,ne(B(),y())?B():ve(B())),"$debugData",n)}),We(),He();var ce=dr(),ie=I(ce);{var Ne=o=>{var s=Qe();c(o,s)};D(ie,o=>{u(ye)||o(Ne)})}var Ie=C(ie,2);{var Ce=o=>{var s=tr();let e;var r=f(s),_=f(r),J=f(_,!0);g(_);var k=C(_,2),m=f(k),De=f(m);{var Ee=d=>{var a=Xe();c(d,a)},je=d=>{var a=$e();c(d,a)};D(De,d=>{u(R)?d(je,!1):d(Ee)})}g(m);var Ae=C(m,2);{var Te=d=>{var a=er();let x;var S=f(a,!0);g(a),K(T=>{x=W(a,1,"",null,x,T),be(S,(i(),O(()=>i().status)))},[()=>({"super-debug--info":i().status<200,"super-debug--success":i().status>=200&&i().status<300,"super-debug--redirect":i().status>=300&&i().status<400,"super-debug--error":i().status>=400})],Q),c(d,a)};D(Ae,d=>{_e()&&d(Te)})}g(k),g(r);var A=C(r,2);let le;var ue=f(A),Me=f(ue);Re(Me,t,"default",{},d=>{var a=H(),x=I(a);{var S=N=>{var M=H(),G=I(M);Be(G,E,V=>{var p=or();c(V,p)},(V,p)=>{var F=H(),U=I(F);X(U,()=>(b(u(p)),b(y()),b(me),O(()=>Z(ne(u(p),y())?me(u(p)):u(p))))),c(V,F)},(V,p)=>{var F=rr(),U=C(I(F),2);X(U,()=>(b(u(p)),O(()=>Z(u(p))))),c(V,F)}),c(N,M)},T=N=>{var M=H(),G=I(M);X(G,()=>(E(),O(()=>Z(E())))),c(N,M)};D(x,N=>{E(),b(y()),b(se()),O(()=>Se(E(),y(),se()))?N(S):N(T,!1)})}c(d,a)}),g(ue),g(A),Le(A,d=>oe(d),()=>oe());var Ve=C(A,2);{var Fe=d=>{var a=sr(),x=f(a);let S;g(a),K(T=>S=W(x,0,"",null,S,T),[()=>({"super-debug--rotated":w()})],Q),fe("click",a,qe(()=>de(!w()))),c(d,a)};D(Ve,d=>{Y()&&d(Fe)})}g(s),K((d,a)=>{e=W(s,1,"super-debug",null,e,d),Je(s,u(ee)),W(r,1,`super-debug--status ${P()===""?"super-debug--absolute super-debug--inset-x-0 super-debug--top-0":""}`),be(J,P()),le=W(A,1,"super-debug--pre",null,le,a),s.dir=s.dir},[()=>({"super-debug--collapsible":Y()}),()=>({"super-debug--with-label":P(),"super-debug--hidden":w()})],Q),fe("click",m,xe),c(o,s)};D(Ie,o=>{we()&&o(Ce)})}c(v,ce),ze(),z()}export{kr as S};
