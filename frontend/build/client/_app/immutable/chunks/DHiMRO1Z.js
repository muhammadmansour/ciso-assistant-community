import"./Bzak7iHL.js";import"./69_IOA4Y.js";import{p as Oe,aU as pe,k as L,T as q,au as b,aV as ze,f as h,i as I,g as u,s as C,b as c,c as Be,d as f,r as g,t as K,ac as Q,l as he,y as O,h as H}from"./B5_J1eZO.js";import{s as be,e as fe}from"./DhVUxA_H.js";import{a as Re}from"./B3T8groU.js";import{i as D}from"./CxmTzuB0.js";import{h as X}from"./Ba4v9qbf.js";import{s as We}from"./BeTtb8R-.js";import{s as z}from"./7M20SbCD.js";import{s as Je}from"./BpLHmG0c.js";import{b as Le}from"./D_HHtX4o.js";import{p as qe}from"./DEoobfLV.js";import{i as He}from"./BgowPYUp.js";import{p as l,a as ge,e as Pe,s as Ue}from"./S6gTM6mH.js";import{p as Ye}from"./DYumy1Ak.js";import{r as ve,g as me}from"./BAD7lgiB.js";/*! clipboard-copy. MIT License. Feross Aboukhadijeh <https://feross.org/opensource> */function $(){return new DOMException("The request is not allowed","NotAllowedError")}async function Ze(v){if(!navigator.clipboard)throw $();return navigator.clipboard.writeText(v)}async function Ge(v){const t=document.createElement("span");t.textContent=v,t.style.whiteSpace="pre",t.style.webkitUserSelect="auto",t.style.userSelect="all",document.body.appendChild(t);const n=window.getSelection(),B=window.document.createRange();n==null||n.removeAllRanges(),B.selectNode(t),n==null||n.addRange(B);let i=!1;try{i=window.document.execCommand("copy")}finally{n==null||n.removeAllRanges(),window.document.body.removeChild(t)}if(!i)throw $()}async function Ke(v){try{await Ze(v)}catch(t){try{await Ge(v)}catch(n){throw n||t||$()}}}var Qe=h(`<style>.super-debug--absolute {
			position: absolute;
		}
		...
		}</style>`),Xe=he('<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M7 9.667A2.667 2.667 0 0 1 9.667 7h8.666A2.667 2.667 0 0 1 21 9.667v8.666A2.667 2.667 0 0 1 18.333 21H9.667A2.667 2.667 0 0 1 7 18.333z"></path><path d="M4.012 16.737A2.005 2.005 0 0 1 3 15V5c0-1.1.9-2 2-2h10c.75 0 1.158.385 1.5 1"></path></g></svg>'),$e=he('<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M15 12v6m-3-3h6"></path><rect width="14" height="14" x="8" y="8" rx="2" ry="2"></rect><path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"></path></g></svg>'),er=h("<div> </div>"),rr=h('<span class="super-debug--promise-rejected">Rejected:</span> <!>',1),or=h('<div class="super-debug--promise-loading">Loading data...</div>'),sr=h('<button type="button" class="super-debug--collapse" aria-label="Collapse"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M4.08 11.92L12 4l7.92 7.92l-1.42 1.41l-5.5-5.5V22h-2V7.83l-5.5 5.5l-1.42-1.41M12 4h10V2H2v2h10Z"></path></svg></button>'),tr=h('<div dir="ltr"><div><div class="super-debug--label"> </div> <div class="super-debug--right-status"><button type="button" class="super-debug--copy"><!></button> <!></div></div> <pre><code class="super-debug--code"><!></code></pre> <!></div>'),dr=h("<!> <!>",1);function kr(v,t){Oe(t,!1);const[n,B]=Ue(),i=()=>ge(Ye,"$page",n),E=()=>ge(u(re),"$debugData",n),ee=q(),re=q();let ye=q(!1),R=l(t,"data",8),we=l(t,"display",8,!0),_e=l(t,"status",8,!0),P=l(t,"label",8,""),j=l(t,"stringTruncate",8,120),oe=l(t,"ref",12,void 0),se=l(t,"promise",8,!1),y=l(t,"raw",8,!1),ke=l(t,"functions",8,!1),te=l(t,"theme",8,"default"),U=l(t,"collapsible",8,!1),w=l(t,"collapsed",12,!1);U()&&de();function de(o=void 0){let s;const e=i().route.id??"";try{sessionStorage.SuperDebug&&(s=JSON.parse(sessionStorage.SuperDebug)),s={collapsed:s&&s.collapsed?s.collapsed:{}},s.collapsed[e]=o===void 0?s.collapsed[e]??w():o}catch{s={collapsed:{[e]:w()}}}o!==void 0&&(sessionStorage.SuperDebug=JSON.stringify(s)),w(s.collapsed[e])}let W=q();async function xe(o){if(!o.target)return;const s=o.target.closest(".super-debug");if(!s)return;const e=s.querySelector(".super-debug--code");e&&(clearTimeout(u(W)),await Ke(e.innerText),L(W,setTimeout(()=>L(W,void 0),900)))}function ae(o){return{name:o.name,size:o.size,type:o.type,lastModified:new Date(o.lastModified)}}function Y(o){switch(typeof o){case"function":return`<span class="function">[function ${o.name??"unnamed"}]</span>`;case"symbol":return`<span class="symbol">${o.toString()}</span>`}return JSON.stringify(o,function(e,r){if(r===void 0)return"#}#undefined";if(typeof this=="object"&&this[e]instanceof Date)return"#}D#"+(isNaN(this[e])?"Invalid Date":r);if(typeof r=="number"){if(r==Number.POSITIVE_INFINITY)return"#}#Inf";if(r==Number.NEGATIVE_INFINITY)return"#}#-Inf";if(isNaN(r))return"#}#NaN"}if(typeof r=="bigint")return"#}BI#"+r;if(typeof r=="function"&&ke())return`#}F#[function ${r.name}]`;if(r instanceof Error)return`#}E#${r.name}: ${r.message||r.cause||"(No error message)"}`;if(r instanceof Set)return Array.from(r);if(r instanceof Map)return Array.from(r.entries());if(typeof this=="object"&&typeof this[e]=="object"&&this[e]&&"toExponential"in this[e])return"#}DE#"+this[e].toString();if(typeof this=="object"&&this[e]instanceof File)return ae(this[e]);if(typeof this=="object"&&this[e]instanceof FileList){const _=this[e],J=[];for(let k=0;k<_.length;k++){const m=_.item(k);m&&J.push(ae(m))}return J}return r},2).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/("(\\u[a-zA-Z0-9]{4}|\\[^u]|[^\\"])*"(\s*:)?|\b(true|false|null)\b|-?\d+(?:\.\d*)?(?:[eE][+-]?\d+)?)/g,function(e){let r="number";return/^"/.test(e)?/:$/.test(e)?(r="key",e=e.slice(1,-2)+":"):(r="string",e=j()>0&&e.length>j()?e.slice(0,j()/2)+`[..${e.length-j()}/${e.length}..]`+e.slice(-j()/2):e,e=='"#}#undefined"'?(r="undefined",e="undefined"):e.startsWith('"#}D#')?(r="date",e=e.slice(5,-1)):e=='"#}#NaN"'?(r="nan",e="NaN"):e=='"#}#Inf"'?(r="nan",e="Infinity"):e=='"#}#-Inf"'?(r="nan",e="-Infinity"):e.startsWith('"#}BI#')?(r="bigint",e=e.slice(6,-1)+"n"):e.startsWith('"#}F#')?(r="function",e=e.slice(5,-1)):e.startsWith('"#}E#')?(r="error",e=e.slice(5,-1)):e.startsWith('"#}DE#')&&(r="number",e=e.slice(6,-1))):/true|false/.test(e)?r="boolean":/null/.test(e)&&(r="null"),'<span class="'+r+'">'+e+"</span>"})}function Ne(o,s,e){return s?!1:e||typeof o=="object"&&o!==null&&"then"in o&&typeof o.then=="function"}function ne(o,s){return s?!1:typeof o=="object"&&o!==null&&"subscribe"in o&&typeof o.subscribe=="function"}pe(()=>b(te()),()=>{L(ee,te()==="vscode"?`
    ...
    `:void 0)}),pe(()=>(b(R()),b(y()),ve),()=>{Pe(L(re,ne(R(),y())?R():ve(R())),"$debugData",n)}),ze(),He();var ce=dr(),ie=I(ce);{var Se=o=>{var s=Qe();c(o,s)};D(ie,o=>{u(ye)||o(Se)})}var Ie=C(ie,2);{var Ce=o=>{var s=tr();let e;var r=f(s),_=f(r),J=f(_,!0);g(_);var k=C(_,2),m=f(k),De=f(m);{var Ee=d=>{var a=Xe();c(d,a)},je=d=>{var a=$e();c(d,a)};D(De,d=>{u(W)?d(je,!1):d(Ee)})}g(m);var Ae=C(m,2);{var Te=d=>{var a=er();let x;var N=f(a,!0);g(a),K(T=>{x=z(a,1,"",null,x,T),be(N,(i(),O(()=>i().status)))},[()=>({"super-debug--info":i().status<200,"super-debug--success":i().status>=200&&i().status<300,"super-debug--redirect":i().status>=300&&i().status<400,"super-debug--error":i().status>=400})],Q),c(d,a)};D(Ae,d=>{_e()&&d(Te)})}g(k),g(r);var A=C(r,2);let le;var ue=f(A),Me=f(ue);We(Me,t,"default",{},d=>{var a=H(),x=I(a);{var N=S=>{var M=H(),Z=I(M);Re(Z,E,V=>{var p=or();c(V,p)},(V,p)=>{var F=H(),G=I(F);X(G,()=>(b(u(p)),b(y()),b(me),O(()=>Y(ne(u(p),y())?me(u(p)):u(p))))),c(V,F)},(V,p)=>{var F=rr(),G=C(I(F),2);X(G,()=>(b(u(p)),O(()=>Y(u(p))))),c(V,F)}),c(S,M)},T=S=>{var M=H(),Z=I(M);X(Z,()=>(E(),O(()=>Y(E())))),c(S,M)};D(x,S=>{E(),b(y()),b(se()),O(()=>Ne(E(),y(),se()))?S(N):S(T,!1)})}c(d,a)}),g(ue),g(A),Le(A,d=>oe(d),()=>oe());var Ve=C(A,2);{var Fe=d=>{var a=sr(),x=f(a);let N;g(a),K(T=>N=z(x,0,"",null,N,T),[()=>({"super-debug--rotated":w()})],Q),fe("click",a,qe(()=>de(!w()))),c(d,a)};D(Ve,d=>{U()&&d(Fe)})}g(s),K((d,a)=>{e=z(s,1,"super-debug",null,e,d),Je(s,u(ee)),z(r,1,`super-debug--status ${P()===""?"super-debug--absolute super-debug--inset-x-0 super-debug--top-0":""}`),be(J,P()),le=z(A,1,"super-debug--pre",null,le,a),s.dir=s.dir},[()=>({"super-debug--collapsible":U()}),()=>({"super-debug--with-label":P(),"super-debug--hidden":w()})],Q),fe("click",m,xe),c(o,s)};D(Ie,o=>{we()&&o(Ce)})}c(v,ce),Be(),B()}export{kr as S};
