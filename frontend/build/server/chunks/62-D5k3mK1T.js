...
import { aa as ebiosrmfearedeventssubtitle4, ab as fearedevents1 } from './_index-Syqrsmaf.js';
...
const load = async ({ params, fetch }) => {
  ...
  if (gravityChoicesResponse.ok) {
    selectOptions["gravity"] = await gravityChoicesResponse.json().then(
  ...
  return {
    ...
    table,
    title: fearedevents1(),
    modelVerboseName: ebiosrmfearedeventssubtitle4()
  };
};
const actions = {
  create: async (event) => {
...
//# sourceMappingURL=62-D5k3mK1T.js.map
