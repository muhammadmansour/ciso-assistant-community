...
import { n as noop$2 } from './index2-9icAqEyj.js';
...
function bindable(props) {
  ...
  return {
    ...
    get,
    set(val) {
      const exec = props().sync ? noop$2 : identity;
      exec(() => setValueFn(val));
    },
...
export { proxyTabFocus as $, isMac as A, memo as B, isNumber as C, getValuePercent as D, setup as E, isAnchorElement as F, trackElementRect as G, nextTick as H, raf as I, clickIfLink as J, isOpeningInNewTab as K, isSelfTarget as L, isComposingEvent as M, itemById as N, getFocusables as O, isLeftClick as P, addDomEvent as Q, getOverflowAncestors as R, mergeProps as S, toStyleString as T, noop as U, isHTMLElement as V, isNull as W, compact as X, runIfFn as Y, getComputedStyle as Z, getInitialFocus as _, createGuards as a, setStyleProperty as a0, setStyle as a1, isIos as a2, isFunction as a3, getTabbables as a4, isTabbable as a5, getTabIndex as a6, contains as a7, waitForElements as a8, isShadowRoot as a9, isTouchDevice as aa, callAll as ab, isFocusable as ac, isContextMenuEvent as ad, getNearestOverflowAncestor as ae, isDocument as af, getActiveElement as ag, add as b, createMachine as c, createAnatomy as d, dataAttr as e, first as f, getEventKey as g, normalizeProps as h, isSafari as i, createProps as j, getEventTarget as k, last as l, dispatchInputCheckedEvent as m, nextById as n, trackPress as o, prevById as p, queryAll as q, remove as r, setElementChecked as s, trackFormControl as t, useMachine as u, visuallyHiddenStyle as v, warn as w, getWindow as x, getDocument as y, isVirtualClick as z };
//# sourceMappingURL=machine.svelte-CWLOiKlV.js.map
