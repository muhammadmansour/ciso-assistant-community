...
import { d as RequirementAssessmentSchema } from './schemas-DxPQoveO.js';
import { p as page } from './index3-BwfRm5YV.js';
import { A as AutocompleteSelect } from './crud-CFDLlT9z.js';
...
function _page($$payload, $$props) {
  ...
  $$payload.out += `<!--]--> `;
  {
    let children = function($$payload2, { form: form2, data: data2 }) {
      ...
      if (localAiAnalyses?.length > 0) {
        $$payload2.out += "<!--[-->";
        const each_array_9 = ensure_array_like(localAiAnalyses);
        $$payload2.out += `<div class="space-y-1"><!--[-->`;
        for (let $$index_9 = 0, $$length = each_array_9.length; $$index_9 < $$length; $$index_9++) {
          let analysis = each_array_9[$$index_9];
...
//# sourceMappingURL=_page.svelte-9khWJGNq.js.map
