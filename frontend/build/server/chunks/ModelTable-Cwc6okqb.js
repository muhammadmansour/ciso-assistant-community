import { p as push, M as store_get, ac as store_mutate, W as ensure_array_like, S as attr_class, X as stringify, V as escape_html, U as clsx, T as attr, Q as unsubscribe_stores, R as bind_props, a as pop, ab as maybe_selected, Y as spread_props, _ as spread_attributes, Z as attr_style } from './index2-9icAqEyj.js';
...
import { C2 as objectsnotvisible2, D as loading, sU as searchplaceholder1, s1 as show, KD as entries, e as edit, OD as _delete, ts as rowcount1, D7 as noentriesfound2, zV as previous, Dx as next, J9 as filters, nZ as view, _I as accept, cT as islocked1, ME as deleteusermessage2, NH as deletemodalmessage2, NG as deletemodaltitle2, kS as yes, Qr as confirmyes1, Qq as confirmyesplaceholder3, bt as cancel, kK as submit, Ig as graph } from './_index-BQcvYRD4.js';
...
import { t as tableStates, e as tableHandlers } from './stores-D-WMoATo.js';
import { c as arrayType, s as stringType, o as objectType } from './string-BMZjP7XX.js';
import { z as zod } from './zod-BTgf12zS.js';
import './client-DqP3yP6V.js';
import { D as DeleteConfirmModal } from './DeleteConfirmModal-BVIf1kgK.js';
...
function TableRowActions($$payload, $$props) {
  ...
  if (!hasBody) {
    ...
    if (displayDelete) {
      ...
      if (URLModel === "folders") {
        $$payload.out += "<!--[-->";
        $$payload.out += `<button class="cursor-pointer text-red-400 hover:text-red-600 transition-colors"${attr("aria-label", _delete())} data-testid="tablerow-delete-button"><i class="fa-solid fa-trash"></i></button>`;
      } else {
        $$payload.out += "<!--[!-->";
        $$payload.out += `<button class="cursor-pointer text-red-400 hover:text-red-600 transition-colors"${attr("aria-label", _delete())} data-testid="tablerow-delete-button"><i class="fa-solid fa-trash"></i></button>`;
      }
...
function Pagination($$payload, $$props) {
  ...
  $$payload.out += `<section class="flex"><button type="button"${attr_class("svelte-1ezbi8j", void 0, {
  ...
  if (store_get($$store_subs ??= {}, "$pages", pages) === void 0) {
    $$payload.out += "<!--[-->";
    $$payload.out += `<button type="button" class="svelte-1ezbi8j">${escape_html(store_get($$store_subs ??= {}, "$pageNumber", pageNumber))}</button>`;
  } else {
    $$payload.out += "<!--[!-->";
    ...
    for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
      ...
      $$payload.out += `<button type="button"${attr_class("svelte-1ezbi8j", void 0, {
...
function ModelTable($$payload, $$props) {
  ...
  $$payload.out += `<div${attr_class(`table-wrap ${stringify(classesBase)} rounded-lg overflow-hidden relative`, "svelte-1iwp4z0")}>`;
  if (isLoading) {
    $$payload.out += "<!--[-->";
    $$payload.out += `<div class="absolute top-0 left-0 right-0 h-0.5 z-30 pointer-events-none overflow-hidden bg-blue-100/60 svelte-1iwp4z0" aria-hidden="true"><div class="model-table-indeterminate-bar absolute h-full bg-blue-500 svelte-1iwp4z0"></div></div>`;
  } else {
    $$payload.out += "<!--[!-->";
  }
  $$payload.out += `<!--]--> <header class="flex justify-between items-center space-x-8 p-3 border-b border-gray-100 svelte-1iwp4z0">`;
  if (!hideFilters) {
    $$payload.out += "<!--[-->";
    {
      let trigger = function($$payload2) {
        $$payload2.out += `<i class="fa-solid fa-filter mr-2 svelte-1iwp4z0"></i> ${escape_html(filters())} `;
        if (filterCount) {
          $$payload2.out += "<!--[-->";
          $$payload2.out += `<span class="text-sm svelte-1iwp4z0">${escape_html(filterCount)}</span>`;
        } else {
          $$payload2.out += "<!--[!-->";
        }
        $$payload2.out += `<!--]-->`;
  ...
  $$payload.out += `<!--]--> <div class="flex space-x-2 items-center svelte-1iwp4z0">`;
  optButton?.($$payload);
  $$payload.out += `<!----> `;
  if (canSelectObject) {
    $$payload.out += "<!--[-->";
  ...
  if (hiddenRowCount > 0) {
    $$payload.out += "<!--[-->";
    $$payload.out += `<div class="mx-2 mb-2 rounded border border-yellow-200 bg-yellow-50 px-3 py-2 text-xs text-yellow-800 svelte-1iwp4z0">${escape_html(objectsnotvisible2({ count: hiddenRowCount }))}</div>`;
  } else {
    $$payload.out += "<!--[!-->";
  }
  $$payload.out += `<!--]--> <table${attr_class(`table caption-bottom ${stringify(classesTable)}`, "svelte-1iwp4z0", { "table-interactive": interactive })} role="grid"><thead${attr_class(`table-head ${stringify(regionHead)}`, "svelte-1iwp4z0")}><tr class="svelte-1iwp4z0"><!--[-->`;
  ...
  if (displayActions) {
    $$payload.out += "<!--[-->";
    $$payload.out += `<th${attr_class(`${stringify(regionHeadCell)} select-none text-end`, "svelte-1iwp4z0")}></th>`;
  } else {
    $$payload.out += "<!--[!-->";
  }
  $$payload.out += `<!--]--></tr>`;
  if (thFilter) {
    ...
    $$payload.out += `<tr class="svelte-1iwp4z0"><!--[-->`;
    for (let $$index_2 = 0, $$length = each_array_2.length; $$index_2 < $$length; $$index_2++) {
      ...
      if (thFilterFields.includes(key)) {
        ...
        $$payload.out += "<!--[!-->";
        $$payload.out += `<th class="svelte-1iwp4z0"></th>`;
      }
      $$payload.out += `<!--]-->`;
    }
    $$payload.out += `<!--]--></tr>`;
      ...
      $$payload2.out += `<!---->`;
      {
        let child = function($$payload3, { props }) {
          ...
          for (let rowIndex = 0, $$length = each_array_3.length; rowIndex < $$length; rowIndex++) {
            ...
            $$payload3.out += `<tr${attr("aria-rowindex", rowIndex + 1)} class="hover:bg-blue-50/50 even:bg-gray-50/30 cursor-pointer transition-colors duration-150 svelte-1iwp4z0"><!--[-->`;
            for (let $$index_5 = 0, $$length2 = each_array_4.length; $$index_5 < $$length2; $$index_5++) {
              ...
              if (key !== "meta") {
                ...
                $$payload3.out += `<td role="gridcell" class="svelte-1iwp4z0"><div${attr_class(clsx(regionCell), "svelte-1iwp4z0")}>`;
                {
                  $$payload3.out += "<!--[!-->";
                  $$payload3.out += `<div data-testid="model-table-td-array-elem" class="base-font-family whitespace-pre-line break-words svelte-1iwp4z0">`;
                  if (Array.isArray(value)) {
                    ...
                    if (visibleValues.length > 0) {
                      ...
                      $$payload3.out += `<ul class="list-disc pl-4 whitespace-normal svelte-1iwp4z0"><!--[-->`;
                      for (let $$index_3 = 0, $$length3 = each_array_5.length; $$index_3 < $$length3; $$index_3++) {
                        let val = each_array_5[$$index_3];
                        $$payload3.out += `<li class="svelte-1iwp4z0">`;
                        if (key === "linked_models" && typeof val === "string") {
                          ...
                          $$payload3.out += "<!--[4-->";
                          $$payload3.out += `<span class="text svelte-1iwp4z0">${escape_html(unsafeTranslate(val.split(":")[0] + "Colon"))}
                      ...
                      if (hiddenCount > 0) {
                        $$payload3.out += "<!--[-->";
                        $$payload3.out += `<p class="mt-1 text-xs text-yellow-700 svelte-1iwp4z0">${escape_html(objectsnotvisible2({ count: hiddenCount }))}</p>`;
                      } else {
                        $$payload3.out += "<!--[!-->";
                      }
                      $$payload3.out += `<!--]-->`;
                      ...
                      $$payload3.out += "<!--[1-->";
                      $$payload3.out += `<p class="text-xs text-yellow-700 svelte-1iwp4z0">${escape_html(objectsnotvisible2({ count: hiddenCount }))}</p>`;
                    } else {
                      $$payload3.out += "<!--[!-->";
                      $$payload3.out += `--`;
                    }
                    ...
                    if (isRelatedField(key)) {
                      $$payload3.out += "<!--[-->";
                      $$payload3.out += `<p class="text-xs text-yellow-700 svelte-1iwp4z0">${escape_html(objectsnotvisible2({ count: 1 }))}</p>`;
                    } else {
                      $$payload3.out += "<!--[!-->";
                      $$payload3.out += `--`;
                    }
                    ...
                    $$payload3.out += `<span${attr_class(`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${stringify(statusLower === "active" || statusLower === "in progress" || statusLower === "in_progress" ? "bg-green-100 text-green-700" : statusLower === "planned" ? "bg-gray-100 text-gray-600" : statusLower === "done" || statusLower === "completed" ? "bg-blue-100 text-blue-700" : statusLower === "in review" || statusLower === "in_review" ? "bg-amber-100 text-amber-700" : statusLower === "deprecated" || statusLower === "expired" ? "bg-red-100 text-red-700" : statusLower === "draft" ? "bg-slate-100 text-slate-600" : statusLower === "approved" ? "bg-emerald-100 text-emerald-700" : statusLower === "missing" || statusLower === "rejected" ? "bg-rose-100 text-rose-700" : statusLower === "new" ? "bg-sky-100 text-sky-700" : statusLower === "ongoing" ? "bg-indigo-100 text-indigo-700" : statusLower === "resolved" || statusLower === "closed" ? "bg-teal-100 text-teal-700" : statusLower === "dismissed" ? "bg-zinc-100 text-zinc-600" : "bg-gray-100 text-gray-600")}`, "svelte-1iwp4z0")}>${escape_html(safeTranslate(statusStr))}</span>`;
                    ...
                    $$payload3.out += "<!--[4-->";
                    $$payload3.out += `<p${attr_class(`flex w-fit min-w-24 justify-center px-2 py-1 rounded-md ml-2 whitespace-nowrap ${stringify(classesHexBackgroundText(value.hexcolor))}`, "svelte-1iwp4z0")}${attr_style(`background-color: ${stringify(value.hexcolor)}`)}>${escape_html(safeTranslate(value.name ?? value.str) ?? "-")}</p>`;
                    ...
                    $$payload3.out += "<!--[6-->";
                    $$payload3.out += `<span class="ml-4 svelte-1iwp4z0">${escape_html(safeTranslate(value ?? "-"))}</span>`;
                  } else if (key === "progress") {
                    $$payload3.out += "<!--[7-->";
                    $$payload3.out += `<span class="ml-9 svelte-1iwp4z0">${escape_html(safeTranslate("percentageDisplay", { number: value }))}</span>`;
                  } else if (key === "translations") {
                    $$payload3.out += "<!--[8-->";
                    if (Object.keys(value).length > 0) {
                      $$payload3.out += "<!--[-->";
                      const each_array_6 = ensure_array_like(Object.entries(value));
                      $$payload3.out += `<div class="flex flex-col gap-2 svelte-1iwp4z0"><!--[-->`;
                      for (let $$index_4 = 0, $$length3 = each_array_6.length; $$index_4 < $$length3; $$index_4++) {
                        let [lang, translation] = each_array_6[$$index_4];
                        $$payload3.out += `<div class="flex flex-row gap-2 svelte-1iwp4z0"><strong class="svelte-1iwp4z0">${escape_html(lang)}:</strong> <span class="svelte-1iwp4z0">${escape_html(safeTranslate(translation))}</span></div>`;
                      }
                      $$payload3.out += `<!--]--></div>`;
                    } else {
                      $$payload3.out += "<!--[!-->";
                    ...
                    $$payload3.out += "<!--[9-->";
                    $$payload3.out += `<div class="flex items-center space-x-2 svelte-1iwp4z0"><span class="svelte-1iwp4z0">${escape_html(safeTranslate(value ?? "-"))}</span> <span class="bg-green-100 text-green-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded-sm dark:bg-green-200 dark:text-green-900 svelte-1iwp4z0">${escape_html(accept())}</span></div>`;
                  } else if ((key === "name" || key === "str") && row.meta?.is_locked) {
                    $$payload3.out += "<!--[10-->";
                    $$payload3.out += `<div class="flex items-center space-x-2 svelte-1iwp4z0"><i class="fa-solid fa-lock text-yellow-600 svelte-1iwp4z0"${attr("title", islocked1())}></i> <span class="text-yellow-600 svelte-1iwp4z0">${escape_html(safeTranslate(value ?? "-"))}</span></div>`;
                  } else if (key === "icon_fa_class") {
                    $$payload3.out += "<!--[11-->";
                    $$payload3.out += `<i${attr_class(`text-lg fa ${stringify(value)}`, "svelte-1iwp4z0")}></i>`;
            ...
            if (displayActions) {
              $$payload3.out += "<!--[-->";
              $$payload3.out += `<td${attr_class(`text-end ${stringify(regionCell)}`, "svelte-1iwp4z0")} role="gridcell">`;
              if (actions) {
                $$payload3.out += "<!--[-->";
  ...
  if (tableSource.foot) {
    ...
    $$payload.out += `<tfoot${attr_class(`table-foot ${stringify(regionFoot)}`, "svelte-1iwp4z0")}><tr class="svelte-1iwp4z0"><!--[-->`;
    for (let $$index_8 = 0, $$length = each_array_8.length; $$index_8 < $$length; $$index_8++) {
      let cell = each_array_8[$$index_8];
      $$payload.out += `<td${attr_class(clsx(regionFootCell), "svelte-1iwp4z0")}>${escape_html(cell)}</td>`;
    }
    $$payload.out += `<!--]--></tr></tfoot>`;
  } else {
    $$payload.out += "<!--[!-->";
  }
  $$payload.out += `<!--]--></table> <footer class="flex justify-between items-center space-x-8 p-3 border-t border-gray-100 bg-gray-50/30 svelte-1iwp4z0">`;
  ...
  $$payload.out += `<!--]--></footer> `;
  if (isLoading && store_get($$store_subs ??= {}, "$rows", rows).length === 0) {
    $$payload.out += "<!--[-->";
    $$payload.out += `<div class="absolute inset-0 flex items-center justify-center bg-white/70 backdrop-blur-[1px] z-20 svelte-1iwp4z0" role="status" aria-live="polite"${attr("aria-label", loading())}><div class="flex flex-col items-center gap-3 text-gray-500 svelte-1iwp4z0"><i class="fa-solid fa-circle-notch fa-spin text-3xl text-blue-500 svelte-1iwp4z0"></i> <span class="text-sm font-medium svelte-1iwp4z0">${escape_html(loading())}…</span></div></div>`;
  } else {
    $$payload.out += "<!--[!-->";
  }
  $$payload.out += `<!--]--></div>`;
...
//# sourceMappingURL=ModelTable-Cwc6okqb.js.map
