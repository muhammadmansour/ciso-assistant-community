...
import { KS as download, G as loading } from './_index-DZs3gE-i.js';
    ...
    $$payload.out += `<div class="card mt-8 bg-white shadow-lg">`;
    {
      let list = function($$payload2) {
        ...
        Tabs.Control($$payload2, {
          ...
          children: ($$payload3) => {
            $$payload3.out += `<i class="fa-solid fa-tags mr-2"></i> Entity Extraction`;
          },
          $$slots: { default: true }
        });
        $$payload2.out += `<!----> <!---->`;
        ...
        Tabs.Panel($$payload2, {
          value: "preview",
          children: ($$payload3) => {
            $$payload3.out += `<div class="p-6 space-y-4"><div class="flex flex-row justify-between"><h4 class="h4 font-semibold" data-testid="attachment-name-title">${escape_html(data.data.attachment)}</h4> <div class="space-x-2">`;
            Anchor($$payload3, {
            ...
            if (auditResult && true) {
              ...
              if (auditResult.typicalEvidenceCheck && auditResult.typicalEvidenceCheck.length > 0) {
                ...
                for (let $$index_7 = 0, $$length = each_array_7.length; $$index_7 < $$length; $$index_7++) {
                  ...
                  $$payload3.out += `<tr class="border-b hover:bg-gray-50"><td class="p-2 font-medium">${escape_html(item.evidenceItem)}</td><td class="p-2"><span${attr_class(`px-2 py-0.5 rounded text-xs ${stringify(item.status === "Present" ? "bg-green-100 text-green-800" : item.status === "Partial" ? "bg-yellow-100 text-yellow-800" : "bg-red-100 text-red-800")}`)}>${escape_html(item.status)}</span></td><td class="p-2 text-gray-600">${escape_html(item.foundIn || "-")}</td><td class="p-2 text-gray-500 text-xs">${escape_html(item.details || "-")}</td></tr>`;
                }
                $$payload3.out += `<!--]--></tbody></table></div></div>`;
              } else {
                $$payload3.out += "<!--[!-->";
...
//# sourceMappingURL=_page.svelte-DrDQJvZt.js.map
