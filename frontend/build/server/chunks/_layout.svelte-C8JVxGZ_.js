...
import { b as breadcrumbs, g as goto } from './breadcrumbs-TPX_ebIH.js';
import 'driver.js';
...
import 'marked';
import { a as m } from './_index-BQcvYRD4.js';
...
function SideBarFooter($$payload, $$props) {
  push();
  getModalStore();
  $$payload.out += `<div class="border-t border-white/10 pt-3 mt-auto space-y-3"><div class="flex flex-row items-center justify-between"><div class="flex flex-col w-3/4 min-w-0">`;
  if (page$1.data.user) {
    $$payload.out += "<!--[-->";
  ...
  $$payload.out += `<!--]--></div> `;
  if (WATHBAH_ADMIN_CONSOLE_URL && page$1.data.user) {
    $$payload.out += "<!--[-->";
    $$payload.out += `<a${attr("href", WATHBAH_ADMIN_CONSOLE_URL)} target="_blank" rel="noopener noreferrer" class="flex items-center justify-center gap-2 w-full px-3 py-2.5 rounded-lg border border-white/25 text-white/90 hover:bg-white/10 hover:text-white hover:border-white/40 transition-colors text-sm" data-testid="sidebar-wathbah-admin-console"><i class="fa-solid fa-gear text-white/80"></i> <span class="font-medium">WathbahGRC Admin</span></a>`;
  } else {
    $$payload.out += "<!--[!-->";
  }
  $$payload.out += `<!--]--></div>`;
...
function FloatingPolicyWidget($$payload, $$props) {
  push();
  let selectedCollectionIds = /* @__PURE__ */ new Set();
  {
    $$payload.out += "<!--[!-->";
  }
  $$payload.out += `<!--]--> <div class="fixed bottom-6 ltr:right-6 rtl:left-6 z-50">`;
  {
    $$payload.out += "<!--[!-->";
  }
  $$payload.out += `<!--]--> <button${attr_class(`w-14 h-14 rounded-full shadow-lg flex items-center justify-center transition-all duration-300 hover:scale-110 active:scale-95 ${stringify("bg-gradient-to-r from-[#0A1628] to-[#1a2740] hover:from-[#1a2740] hover:to-[#2a3a66]")}`)}>`;
  {
    $$payload.out += "<!--[!-->";
    $$payload.out += `<i class="fa-solid fa-robot text-white text-xl"></i>`;
  }
  $$payload.out += `<!--]--></button> `;
  if (selectedCollectionIds.size > 0) {
    $$payload.out += "<!--[-->";
    $$payload.out += `<div class="absolute -top-1 ltr:-right-1 rtl:-left-1 w-5 h-5 bg-[#0077CC] text-white text-[10px] font-bold rounded-full flex items-center justify-center">${escape_html(selectedCollectionIds.size)}</div>`;
  } else {
    $$payload.out += "<!--[!-->";
  }
  $$payload.out += `<!--]--></div>`;
...
function PageReady($$payload, $$props) {
  push();
  let { children } = $$props;
  let gated = false;
  $$payload.out += `<div class="page-ready-wrapper relative"><div${attr_class("page-ready-content transition-opacity duration-200 ease-out", void 0, { "opacity-0": gated })}>`;
  children?.($$payload);
  $$payload.out += `<!----></div> `;
  {
    $$payload.out += "<!--[!-->";
...
//# sourceMappingURL=_layout.svelte-C8JVxGZ_.js.map
