import { p as push, X as stringify, a as pop, T as attr } from './index2-9icAqEyj.js';
...
function _page($$payload, $$props) {
  ...
  const URLModel = data.URLModel;
  {
    let addButton = function($$payload2) {
      $$payload2.out += `<span class="inline-flex overflow-hidden rounded-md border bg-white shadow-xs"><button class="inline-block p-3 btn-mini-primary w-12 focus:relative" data-testid="add-button"${attr("title", safeTranslate("add-" + data.model.localName))}><i class="fa-solid fa-file-circle-plus"></i></button></span>`;
    };
    ModelTable($$payload, {
      source: data.table,
      deleteForm: data.deleteForm,
      URLModel,
      baseEndpoint: `/risk-assessments/?ebios_rm_study=${stringify(page.params.id)}`,
      addButton,
...
//# sourceMappingURL=_page.svelte-8IxHBpv5.js.map
