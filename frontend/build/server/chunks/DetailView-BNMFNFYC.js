...
import { ue as riskacceptancenotyetsubmittedmessage5, ub as riskacceptancevalidatingreviewmessage4, oc as validate, v_ as reject, uc as riskacceptancevalidatedmessage3, ur as revoke, dq as syncedwith1, ds as remoteid1, dt as lastsynced1, cE as status, a as m, BR as objectsnotvisible2, oH as undefined$1, B1 as p1, B0 as p2, A$ as p3, A_ as p4, mQ as viewmore1, sn as sendquestionnaire1, LM as draft, LI as duplicate, e as edit, ug as riskacceptancemissingapprovermessage4, kJ as submit, Qh as confirmmodalmessage2, Qg as confirmmodaltitle2, bt as cancel } from './_index-DiaVtc2Z.js';
...
import { c as getListViewFields, g as getModelInfo } from './crud-DzBk-fdF.js';
...
function DetailView($$payload, $$props) {
  ...
  const HIDDEN_RELATED_MODELS = /* @__PURE__ */ new Set([
    "tasks",
    "task-templates",
    "risk-scenarios",
    "findings",
  ...
  function getSortedRelatedModels() {
    return Object.entries(data?.relatedModels ?? {}).filter(([urlmodel]) => !HIDDEN_RELATED_MODELS.has(urlmodel)).sort((a, b) => {
      return getRelatedModelIndex(data.model, a[1]) - getRelatedModelIndex(data.model, b[1]);
    });
  }
  let relatedModels = getSortedRelatedModels();
  let group = getSortedRelatedModels()[0]?.[0];
...
//# sourceMappingURL=DetailView-BNMFNFYC.js.map
