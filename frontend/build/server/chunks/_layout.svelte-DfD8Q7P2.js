...
function NavigationProgress($$payload, $$props) {
  push();
...
function _layout($$payload, $$props) {
  ...
  NavigationProgress($$payload);
  $$payload.out += `<!----> `;
  Modal($$payload, { components: modalRegistry });
  $$payload.out += `<!----> `;
  Toast($$payload, { position: "tr", zIndex: "z-[9999]" });
  $$payload.out += `<!----> `;
  children?.($$payload);
  $$payload.out += `<!----> `;
...
//# sourceMappingURL=_layout.svelte-DfD8Q7P2.js.map
