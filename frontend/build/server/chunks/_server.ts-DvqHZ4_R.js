...
const ENTITY_EXTRACTION_API_URL = process.env.MURAJI_ENTITY_EXTRACTION_API_URL || `${MURAJI_API_BASE_URL}/api/entity-extraction/extract`;
...
export { POST };
//# sourceMappingURL=_server.ts-DvqHZ4_R.js.map
