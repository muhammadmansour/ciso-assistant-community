import { a as nestedWriteFormAction, h as handleErrorResponse } from './actions-BkARH3Iu.js';
import { B as BASE_API_URL } from './constants-B8vm30bZ.js';
import { a as urlParamModelVerboseName, g as getModelInfo, h as headData } from './crud-BJ_TECqM.js';
import { g as getSecureRedirect } from './helpers-Bm9n0CNG.js';
import { m as modelSchema } from './schemas-QFT6TgyO.js';
import { ba as createappliedcontrolsfromsuggestionssuccess5, bb as createappliedcontrolsfromsuggestionserror5, L as successfullyupdatedobject2, be as successfullysavedobject2 } from './_index-DZs3gE-i.js';
...
const actions = {
  ...
  runAiAnalysis: async (event) => {
    ...
    if (!response2.ok) {
      ...
      return fail(response2.status, { aiError: err.message || `Error ${response2.status}` });
    }
...
//# sourceMappingURL=140-BQsG8tk2.js.map
