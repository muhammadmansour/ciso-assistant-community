...
import { p as pageTitle, m as modelName, b as modelDescription, l as lastAccordionItem, d as driverInstance } from './stores-CMqbeBUT.js';
import { w as writable } from './index-CRjgakYW.js';
import './exports-CA5lG8jS.js';
import './state.svelte-B6YM-9h0.js';
import { p as page } from './stores3-psVfZSQ7.js';
import { b as breadcrumbs, g as goto } from './breadcrumbs-CG0qNTv3.js';
import 'driver.js';
...
import 'marked';
import { b as m } from './_index-DEXNURl5.js';
...
function SideBarFooter($$payload, $$props) {
  ...
  getModalStore();
  getLocale();
  $$payload.out += `<div class="border-t border-white/10 pt-3 mt-auto"><div class="flex flex-row items-center justify-between"><div class="flex flex-col w-3/4 min-w-0">`;
  if (page$1.data.user) {
    $$payload.out += "<!--[-->";
...
function SideBarHeader($$payload) {
  $$payload.out += `<header><a href="/my-assignments" class="flex items-center gap-3 border-b border-white/10 pb-4 mb-2 px-1"><div class="w-9 h-9 rounded-lg bg-[#0077CC] flex items-center justify-center flex-shrink-0"><span class="text-lg font-bold text-white">W</span></div> <span class="text-lg font-bold text-white tracking-tight">WathbaGRC</span></a></header>`;
}
const navData = {
  items: [
    {
...
function SideBarNavigation($$payload, $$props) {
  ...
  Anchor($$payload, {
    href: "/my-assignments",
    breadcrumbAction: "replace",
    class: `unstyled flex items-center gap-3 px-4 py-2.5 mb-2 rounded-lg transition-all duration-150 ${stringify(page$1.url.pathname === "/my-assignments" ? "bg-[#0077CC] text-white font-medium" : "text-white/70 hover:bg-[#0077CC]/80 hover:text-white")}`,
...
function Breadcrumbs($$payload, $$props) {
  ...
  $$payload.out += `<ol class="flex items-center gap-2 h-6 overflow-hidden whitespace-nowrap"><li><a href="/my-assignments" class="text-gray-400 hover:text-blue-600 transition-colors" title="Home"><i class="fa-solid fa-house text-sm"></i></a></li> <!--[-->`;
...
function _layout($$payload, $$props) {
  ...
  let $$inner_payload;
  function $$render_inner($$payload2) {
    $$payload2.out += `<div class="overflow-x-hidden min-h-screen bg-[#f0f2f5]">`;
    SideBar($$payload2, {
      sideBarVisibleItems,
      get open() {
        return sidebarOpen;
...
//# sourceMappingURL=_layout.svelte-D5pbe0k3.js.map
