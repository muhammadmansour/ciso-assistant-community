...
function FloatingPolicyWidget($$payload, $$props) {
  ...
  $$payload.out += `<!--]--> <div class="fixed bottom-6 ltr:left-6 rtl:right-6 z-50">`;
  {
    $$payload.out += "<!--[!-->";
  }
  ...
  if (selectedCollectionIds.size > 0) {
    $$payload.out += "<!--[-->";
    $$payload.out += `<div class="absolute -top-1 ltr:-left-1 rtl:-right-1 w-5 h-5 bg-[#0077CC] text-white text-[10px] font-bold rounded-full flex items-center justify-center">${escape_html(selectedCollectionIds.size)}</div>`;
  } else {
    $$payload.out += "<!--[!-->";
  }
  $$payload.out += `<!--]--></div>`;
...
//# sourceMappingURL=_layout.svelte-DyZbiLVI.js.map
