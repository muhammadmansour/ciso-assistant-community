...
const locales = (
  /** @type {const} */
  ["en", "fr", "ar", "pt", "es", "de", "nl", "it", "pl", "ro", "hi", "ur", "cs", "sv", "id", "da", "hu", "uk", "el", "tr", "hr", "zh"]
);
...
function isCustomStrategy(strategy2) {
  return typeof strategy2 === "string" && /^custom-[A-Za-z0-9]+$/.test(strategy2);
}
function defineCustomServerStrategy(strategy2, handler) {
  if (!isCustomStrategy(strategy2)) {
    throw new Error(`Invalid custom strategy: "${strategy2}". Must be a custom strategy following the pattern custom-<name> where <name> contains only alphanumeric characters.`);
  }
  customServerStrategies.set(strategy2, handler);
}

export { serverAsyncLocalStorage as a, defineCustomServerStrategy as b, locales as c, deLocalizeUrl as d, extractLocaleFromRequest as e, getLocale as g, localizeUrl as l, overwriteServerAsyncLocalStorage as o, strategy as s, trackMessageCall as t };
//# sourceMappingURL=runtime-B_ICGJZJ.js.map
