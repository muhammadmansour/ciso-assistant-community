...
import { ac as ebiosrmrotosubtitle4, ad as rotocouples2 } from './_index-Syqrsmaf.js';
...
const load = async ({ params, fetch }) => {
  ...
  return {
    ...
    table,
    title: rotocouples2(),
    modelVerboseName: ebiosrmrotosubtitle4()
  };
};
const actions = {
  create: async (event) => {
...
//# sourceMappingURL=63-CHr2deTQ.js.map
