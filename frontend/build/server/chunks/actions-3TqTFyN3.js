...
import { g as getModelInfo, a as urlParamModelVerboseName } from './crud-DzBk-fdF.js';
import { a5 as successfullydeletedobject2, a6 as successfullycreatedobject2, O as successfullyupdatedobject2 } from './_index-DiaVtc2Z.js';
...
async function defaultWriteFormAction({
  ...
  if ((urlModel === "evidences" || urlModel === "evidence-revisions") && lastFileUploadJson && typeof lastFileUploadJson === "object") {
    const indexingStatus = lastFileUploadJson.indexing_status;
    const indexingError = lastFileUploadJson.indexing_error;
    if (indexingStatus === "completed") {
      ...
      setFlash(
        {
          type: "warning",
          message: indexingError ? `${safeTranslate("evidenceIndexingFailed")}: ${indexingError}` : safeTranslate("evidenceIndexingFailed")
        },
        event
      );
    }
...
//# sourceMappingURL=actions-3TqTFyN3.js.map
