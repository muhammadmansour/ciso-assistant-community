import { p as push, M as store_get, Z as attr_style, V as escape_html, S as attr_class, X as stringify, W as ensure_array_like, T as attr, Q as unsubscribe_stores, a as pop } from './index2-9icAqEyj.js';
import './exports-CA5lG8jS.js';
import './state.svelte-B6YM-9h0.js';
import { p as page } from './index3-BpCge2eg.js';
import { M as ModelTable } from './ModelTable-BFWlDOTv.js';
import { f as complianceStatusColorMap, b as complianceResultColorMap } from './constants-CbUNxZZz.js';
import { e as getRequirementTitle, f as formatScoreValue, d as displayScoreColor } from './helpers-Bm9n0CNG.js';
import { s as safeTranslate, t as toCamelCase } from './i18n-CxHbQmwN.js';
import { h as hideSuggestions } from './stores-D-WMoATo.js';
import { bs as description, XF as additionalinformation1, qY as suggestedreferencecontrols2, pG as threatscovered1, kd as annotation, oK as typicalevidence1, Eo as mappinginference1, En as mappinginferencehelptext3, PL as coveragecolon1, qW as suggestioncolon1, wz as questions, cQ as observation, TP as back, vz as requirementappliedcontrolhelptext4, vq as requirementevidencehelptext3, dx as appliedcontrols1, c_ as evidences } from './_index-DiaVtc2Z.js';
...
function _page($$payload, $$props) {
  ...
  $$payload.out += `<div class="card space-y-2 p-4 bg-white shadow-sm"><div class="flex flex-row space-x-2 items-center"><span class="badge h-fit"${attr_style(`background-color: ${stringify(complianceStatusColorMap[data.requirementAssessment.status] ?? "#d1d5db")};`)}>${escape_html(safeTranslate(data.requirementAssessment.status))}</span> <span${attr_class(`badge ${stringify(classesText)} h-fit`)}${attr_style(`background-color: ${stringify(complianceResultColorMap[data.requirementAssessment.result] ?? "#d1d5db")};`)}>${escape_html(safeTranslate(data.requirementAssessment.result))}</span> `;
...
//# sourceMappingURL=_page.svelte-DBpQYIYR.js.map
