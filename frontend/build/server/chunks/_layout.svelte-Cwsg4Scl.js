...
import { b as breadcrumbs, g as goto } from './breadcrumbs-B1Us7xd5.js';
import 'driver.js';
...
import 'marked';
import { a as m } from './_index-B12BAPce.js';
...
function FloatingPolicyWidget($$payload, $$props) {
  ...
  $$payload.out += `<!--]--> <div class="fixed bottom-6 right-6 z-50">`;
  {
    $$payload.out += "<!--[!-->";
  }
  ...
  if (selectedCollectionIds.size > 0) {
    $$payload.out += "<!--[-->";
    $$payload.out += `<div class="absolute -top-1 -right-1 w-5 h-5 bg-[#0077CC] text-white text-[10px] font-bold rounded-full flex items-center justify-center">${escape_html(selectedCollectionIds.size)}</div>`;
  } else {
    $$payload.out += "<!--[!-->";
  }
  $$payload.out += `<!--]--></div>`;
...
//# sourceMappingURL=_layout.svelte-Cwsg4Scl.js.map
