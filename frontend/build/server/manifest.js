...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/15-DY8G-51O.js')),
			__memo(() => import('./chunks/16-Bat7OhSm.js')),
			...
			__memo(() => import('./chunks/21-Bcv88ktk.js')),
			__memo(() => import('./chunks/22-xnvACZr-.js')),
			__memo(() => import('./chunks/23-TCCXW-Yh.js')),
			__memo(() => import('./chunks/24-DYBAd3Cb.js')),
			__memo(() => import('./chunks/25-ByH-2ck7.js')),
			__memo(() => import('./chunks/26-B6FdzGGb.js')),
			__memo(() => import('./chunks/27-CHpLxzcR.js')),
			__memo(() => import('./chunks/28-C7KUbJ9H.js')),
			__memo(() => import('./chunks/29-83ZInvg7.js')),
			__memo(() => import('./chunks/30-DlZNsejr.js')),
			__memo(() => import('./chunks/31-BxOobBIz.js')),
			__memo(() => import('./chunks/32-ZAJRMU0G.js')),
			__memo(() => import('./chunks/33-cf6MOUUO.js')),
			__memo(() => import('./chunks/34-CayUDYUY.js')),
			__memo(() => import('./chunks/35-B4T0Wh6G.js')),
			__memo(() => import('./chunks/36-BJQwg9kJ.js')),
			__memo(() => import('./chunks/37-ChOqQJZk.js')),
			__memo(() => import('./chunks/38-BEjYQN1z.js')),
			__memo(() => import('./chunks/39-BXvfd03g.js')),
			__memo(() => import('./chunks/40-DV1VMbYH.js')),
			__memo(() => import('./chunks/41-D5oW8K4c.js')),
			__memo(() => import('./chunks/42-BtmKBACb.js')),
			__memo(() => import('./chunks/43-Cvf8Z7x8.js')),
			__memo(() => import('./chunks/44-DeCu8ez6.js')),
			__memo(() => import('./chunks/45-SOvNdbEF.js')),
			__memo(() => import('./chunks/46-CbwlF2ar.js')),
			__memo(() => import('./chunks/47-CXAL5O1h.js')),
			__memo(() => import('./chunks/48-CgOJ-Rlo.js')),
			__memo(() => import('./chunks/49-D6cWAXHy.js')),
			__memo(() => import('./chunks/50-D896deEW.js')),
			__memo(() => import('./chunks/51-C292T0nE.js')),
			__memo(() => import('./chunks/52-CkvmtryP.js')),
			__memo(() => import('./chunks/53-CgGO1_Fs.js')),
			__memo(() => import('./chunks/54-O0Xnojg9.js')),
			__memo(() => import('./chunks/55-DCj6zbKa.js')),
			__memo(() => import('./chunks/56-CmCf3qXd.js')),
			__memo(() => import('./chunks/57-DPSkV0KX.js')),
			__memo(() => import('./chunks/58-CvPIVJJI.js')),
			__memo(() => import('./chunks/59-DiRpOrpH.js')),
			__memo(() => import('./chunks/60-Bh0KuVFD.js')),
			__memo(() => import('./chunks/61-DIE9_FDU.js')),
			__memo(() => import('./chunks/62-xeBT0bfN.js')),
			__memo(() => import('./chunks/63-Dbz51qgg.js')),
			__memo(() => import('./chunks/64-CHGBRWzx.js')),
			__memo(() => import('./chunks/65-DNclk1m6.js')),
			__memo(() => import('./chunks/66-CTcZ-WzF.js')),
			__memo(() => import('./chunks/67-D4aYyNY4.js')),
			__memo(() => import('./chunks/68-CgiSlH8d.js')),
			__memo(() => import('./chunks/69-BKejrY9F.js')),
			__memo(() => import('./chunks/70-DIpZEpS4.js')),
			__memo(() => import('./chunks/71-CzC_2cRd.js')),
			__memo(() => import('./chunks/72-S87piH6j.js')),
			__memo(() => import('./chunks/73-B9JK4wTC.js')),
			__memo(() => import('./chunks/74-AfuC2wLH.js')),
			__memo(() => import('./chunks/75-B6nnvcTc.js')),
			__memo(() => import('./chunks/76-SM5pPE23.js')),
			__memo(() => import('./chunks/77--saBRmVr.js')),
			__memo(() => import('./chunks/78-CCh-Ct-Y.js')),
			__memo(() => import('./chunks/79-DZZrNh7h.js')),
			__memo(() => import('./chunks/80-CAqbeaB2.js')),
			__memo(() => import('./chunks/81-CdFv8lkE.js')),
			__memo(() => import('./chunks/82-lA5sIQ-U.js')),
			__memo(() => import('./chunks/83-BC9vI8x-.js')),
			__memo(() => import('./chunks/84-DCRV75FV.js')),
			__memo(() => import('./chunks/85-Bl3Zo-u-.js')),
			__memo(() => import('./chunks/86-tLxkYjLJ.js')),
			__memo(() => import('./chunks/87-DTZm6OQp.js')),
			__memo(() => import('./chunks/88-avzzRG6J.js')),
			__memo(() => import('./chunks/89-Brc0amgo.js')),
			__memo(() => import('./chunks/90-DV8-Y3_k.js')),
			__memo(() => import('./chunks/91-DHp6qMU2.js')),
			__memo(() => import('./chunks/92-D8QBan-Z.js')),
			__memo(() => import('./chunks/93-B0m-68Oh.js')),
			__memo(() => import('./chunks/94-D7wtLyZR.js')),
			__memo(() => import('./chunks/95-EDXsVwxH.js')),
			__memo(() => import('./chunks/96-C4_9i1JW.js')),
			__memo(() => import('./chunks/97-Bx_maunC.js')),
			__memo(() => import('./chunks/98-alD36-qv.js')),
			__memo(() => import('./chunks/99-Dn_b7hF2.js')),
			__memo(() => import('./chunks/100-fzzndL8G.js')),
			__memo(() => import('./chunks/101-Dy4RXPBu.js')),
			__memo(() => import('./chunks/102-FAjbccOQ.js')),
			__memo(() => import('./chunks/103-DRm1D22a.js')),
			__memo(() => import('./chunks/104-2xREABOb.js')),
			__memo(() => import('./chunks/105-Bj0AfHCY.js')),
			__memo(() => import('./chunks/106-oioCY1rZ.js')),
			__memo(() => import('./chunks/107-C4P_D07h.js')),
			__memo(() => import('./chunks/108-C_a3HQB1.js')),
			__memo(() => import('./chunks/109-DBj0BRle.js')),
			__memo(() => import('./chunks/110-Bk52GJgD.js')),
			__memo(() => import('./chunks/111-DGXJBt24.js')),
			__memo(() => import('./chunks/112-ChwBT5j3.js')),
			__memo(() => import('./chunks/113-BvVxGS1k.js')),
			__memo(() => import('./chunks/114-XmZHuVd9.js')),
			__memo(() => import('./chunks/115-CEmvT_Y_.js')),
			__memo(() => import('./chunks/116-CY10oq_J.js')),
			__memo(() => import('./chunks/117-DQQwwagj.js')),
			__memo(() => import('./chunks/118-Cx-THV_w.js')),
			__memo(() => import('./chunks/119-BsaDOn6V.js')),
			__memo(() => import('./chunks/120-H2LKSbEn.js')),
			__memo(() => import('./chunks/121-B_EVXgh4.js')),
			__memo(() => import('./chunks/122-UjSLBu_H.js')),
			__memo(() => import('./chunks/123-B5WGROQD.js')),
			__memo(() => import('./chunks/124-Dl4o9Ozh.js')),
			__memo(() => import('./chunks/125-D_dguj7A.js')),
			__memo(() => import('./chunks/126-DlERPHa7.js')),
			__memo(() => import('./chunks/127-BnFQM_3G.js')),
			__memo(() => import('./chunks/128-2AmsOvpU.js')),
			__memo(() => import('./chunks/129-DJNZKfnk.js')),
			__memo(() => import('./chunks/130-B_lCL5wc.js')),
			__memo(() => import('./chunks/131-CmcPMBH7.js')),
			__memo(() => import('./chunks/132-_AMWC5bR.js')),
			__memo(() => import('./chunks/133-DXw8tED_.js')),
			__memo(() => import('./chunks/134-BHUeQUHj.js')),
			__memo(() => import('./chunks/135-BGKMQs6C.js')),
			__memo(() => import('./chunks/136-zVtmCLAm.js')),
			__memo(() => import('./chunks/137-C5eeosVp.js')),
			__memo(() => import('./chunks/138-CHDBuXeC.js')),
			__memo(() => import('./chunks/139-D9dzzQIJ.js')),
			__memo(() => import('./chunks/140-BEsjGiTL.js')),
			__memo(() => import('./chunks/141-DZMaEz9X.js')),
			__memo(() => import('./chunks/142-DBRBWZ5x.js')),
			__memo(() => import('./chunks/143-wdrXXohX.js')),
			__memo(() => import('./chunks/144-Cb_ioIUW.js')),
			__memo(() => import('./chunks/145-egIk22I_.js')),
			__memo(() => import('./chunks/146-s_mSmLE8.js')),
			__memo(() => import('./chunks/147-DMcx1I9T.js')),
			__memo(() => import('./chunks/148-1kqkC2CS.js').then(function (n) { return n._; })),
			__memo(() => import('./chunks/149-C2-h-AMS.js')),
			__memo(() => import('./chunks/150-C-EGYxEa.js')),
			__memo(() => import('./chunks/151-D2ECNkMI.js')),
			__memo(() => import('./chunks/152-BK79M96c.js'))
		],
		remotes: {
		...
		routes: [
			...
			},
			{
				...
				endpoint: __memo(() => import('./chunks/_server.ts-CuY6sHdC.js'))
			},
			{
			...
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-CKF5o7Bj.js'))
			},
			{
			...
			},
			{
				...
				endpoint: __memo(() => import('./chunks/_server.ts-BBE20-vc.js'))
			},
			{
				...
				params: [{"name":"model","matcher":"urlmodel","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-oi1Vgth_.js'))
			},
			{
				...
				params: [{"name":"model","matcher":"urlmodel","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-CSHMScHw.js'))
			},
			{
			...
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-yIpHJrYL.js'))
			},
			{
			...
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-CULW1pC6.js'))
			}
		],
		...
		matchers: async () => {
			...
			const { match: filters } = await import ('./chunks/filters-C2nsN7DM.js');
			const { match: fields } = await import ('./chunks/fields-CN6dfIL9.js');
