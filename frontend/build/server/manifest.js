...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/14-Db5x4FCL.js')),
			__memo(() => import('./chunks/15-BiZ_OsZ9.js')),
			...
			__memo(() => import('./chunks/20-CVBrwHWF.js')),
			__memo(() => import('./chunks/21-e7nltxRn.js')),
			__memo(() => import('./chunks/22-B2YWD8Ie.js')),
			__memo(() => import('./chunks/23-BdDso_tf.js')),
			__memo(() => import('./chunks/24-Da6XZLbq.js')),
			__memo(() => import('./chunks/25-D7p0ZINp.js')),
			__memo(() => import('./chunks/26-BQk8Co6U.js')),
			__memo(() => import('./chunks/27-CERZCaWn.js')),
			__memo(() => import('./chunks/28-0LeEJ6KL.js')),
			__memo(() => import('./chunks/29-DwsnAhX9.js')),
			__memo(() => import('./chunks/30-Buxu8l6z.js')),
			__memo(() => import('./chunks/31-CNsEDIBf.js')),
			__memo(() => import('./chunks/32-DGVOynFM.js')),
			__memo(() => import('./chunks/33-jMLwasuz.js')),
			__memo(() => import('./chunks/34-ChEOvQ03.js')),
			__memo(() => import('./chunks/35-C6t2uLQU.js')),
			__memo(() => import('./chunks/36-CkSvHWET.js')),
			__memo(() => import('./chunks/37-BVKkznA5.js')),
			__memo(() => import('./chunks/38-S_3KRk1B.js')),
			__memo(() => import('./chunks/39-Ch7Q6xhp.js')),
			__memo(() => import('./chunks/40-Cd41DNWy.js')),
			__memo(() => import('./chunks/41-Cx8OfJPG.js')),
			__memo(() => import('./chunks/42-D6mKVGcu.js')),
			__memo(() => import('./chunks/43-B0WlCyAR.js')),
			__memo(() => import('./chunks/44-D8oKoyzW.js')),
			__memo(() => import('./chunks/45-C6Q0uGkA.js')),
			__memo(() => import('./chunks/46-D56C5g1W.js')),
			__memo(() => import('./chunks/47-CIzG1Qf9.js')),
			__memo(() => import('./chunks/48-D5IextLM.js')),
			__memo(() => import('./chunks/49-B1or-F1Q.js')),
			__memo(() => import('./chunks/50-CnW-UViA.js')),
			__memo(() => import('./chunks/51-UYVJJ5pH.js')),
			__memo(() => import('./chunks/52-D2exfe4i.js')),
			__memo(() => import('./chunks/53-DZYlSnfw.js')),
			__memo(() => import('./chunks/54-ClEcNYkY.js')),
			__memo(() => import('./chunks/55-lFRlt7Ol.js')),
			__memo(() => import('./chunks/56-s76NVXRb.js')),
			__memo(() => import('./chunks/57-bCJM6rvW.js')),
			__memo(() => import('./chunks/58-BmaEO4_X.js')),
			__memo(() => import('./chunks/59-uS9Bj1Lh.js')),
			__memo(() => import('./chunks/60-DopjjvHv.js')),
			__memo(() => import('./chunks/61-_vCV-_NF.js')),
			__memo(() => import('./chunks/62-BBKzH0-f.js')),
			__memo(() => import('./chunks/63-CAIP0wvp.js')),
			__memo(() => import('./chunks/64-Cb8hJMuy.js')),
			__memo(() => import('./chunks/65-BLcFqB1O.js')),
			__memo(() => import('./chunks/66-BTq23HuD.js')),
			__memo(() => import('./chunks/67-Bwb-KesA.js')),
			__memo(() => import('./chunks/68-CVI_Mkxf.js')),
			__memo(() => import('./chunks/69-Daz7QVA4.js')),
			__memo(() => import('./chunks/70-BktP0IwA.js')),
			__memo(() => import('./chunks/71-Bu4w-YUI.js')),
			__memo(() => import('./chunks/72-C7Iw0o57.js')),
			__memo(() => import('./chunks/73-D-nPJzw7.js')),
			__memo(() => import('./chunks/74-Cxi3IQik.js')),
			__memo(() => import('./chunks/75-B5YuCC1E.js')),
			__memo(() => import('./chunks/76-DA8V939i.js')),
			__memo(() => import('./chunks/77-iwjFQ1OB.js')),
			__memo(() => import('./chunks/78-DzXOZC5L.js')),
			__memo(() => import('./chunks/79-BZnifiWO.js')),
			__memo(() => import('./chunks/80-ygelH3OG.js')),
			__memo(() => import('./chunks/81-BPxql5pk.js')),
			__memo(() => import('./chunks/82-DT5qMaUM.js')),
			__memo(() => import('./chunks/83-wUDGJ-FT.js')),
			__memo(() => import('./chunks/84-PXjNGWND.js')),
			__memo(() => import('./chunks/85-LvlLWn-t.js')),
			__memo(() => import('./chunks/86-Dy2cL_Ql.js')),
			__memo(() => import('./chunks/87-B5KUrpva.js')),
			__memo(() => import('./chunks/88-DGPeteyG.js')),
			__memo(() => import('./chunks/89-BbZbQUeI.js')),
			__memo(() => import('./chunks/90-DP5JMERB.js')),
			__memo(() => import('./chunks/91-Cz93_Cvk.js')),
			__memo(() => import('./chunks/92-1D68Xjng.js')),
			__memo(() => import('./chunks/93-5D8i4uUQ.js')),
			__memo(() => import('./chunks/94-hHXrgE-U.js')),
			__memo(() => import('./chunks/95-Dfaud4lX.js')),
			__memo(() => import('./chunks/96-BBQ4fgBN.js')),
			__memo(() => import('./chunks/97-CaAdvUkj.js')),
			__memo(() => import('./chunks/98-CJS9HdmH.js')),
			__memo(() => import('./chunks/99-D-wT7UVw.js')),
			__memo(() => import('./chunks/100-CnQgkPLu.js')),
			__memo(() => import('./chunks/101-CsYBz9Mi.js')),
			__memo(() => import('./chunks/102-DEbcUXWR.js')),
			__memo(() => import('./chunks/103--UeKjVL3.js')),
			__memo(() => import('./chunks/104-DCoFW1Ed.js')),
			__memo(() => import('./chunks/105-BmdfQY4y.js')),
			__memo(() => import('./chunks/106-DYMAJNtS.js')),
			__memo(() => import('./chunks/107-COIpYXiJ.js')),
			__memo(() => import('./chunks/108-DnoMtNFH.js')),
			__memo(() => import('./chunks/109-BXmgzT2H.js')),
			__memo(() => import('./chunks/110-QQcrwVgu.js')),
			__memo(() => import('./chunks/111-EZr7wHFL.js')),
			__memo(() => import('./chunks/112-BSzYWY-H.js')),
			__memo(() => import('./chunks/113-BSQkqnhU.js')),
			__memo(() => import('./chunks/114-BUfV8XT9.js')),
			__memo(() => import('./chunks/115-BwbMb6XP.js')),
			__memo(() => import('./chunks/116-BAzEzdEE.js')),
			__memo(() => import('./chunks/117-DjaOXW6j.js')),
			__memo(() => import('./chunks/118-BGMBbGEm.js')),
			__memo(() => import('./chunks/119-C9VDP8Gy.js')),
			__memo(() => import('./chunks/120-EQVeIxGe.js')),
			__memo(() => import('./chunks/121-DJIK1xtn.js')),
			__memo(() => import('./chunks/122-DM1BafhU.js')),
			__memo(() => import('./chunks/123-C2-NDiK3.js')),
			__memo(() => import('./chunks/124-2ICHTaIW.js')),
			__memo(() => import('./chunks/125-CB796l2D.js')),
			__memo(() => import('./chunks/126-ui91w_j7.js')),
			__memo(() => import('./chunks/127-N0_PF3A7.js')),
			__memo(() => import('./chunks/128-CLwb4KfQ.js')),
			__memo(() => import('./chunks/129-BzzWScHx.js')),
			__memo(() => import('./chunks/130-DwDxfr41.js')),
			__memo(() => import('./chunks/131-R3O76T7t.js')),
			__memo(() => import('./chunks/132-BtXT-gzD.js')),
			__memo(() => import('./chunks/133-DUk8BQWo.js')),
			__memo(() => import('./chunks/134-B8ijHlDk.js')),
			__memo(() => import('./chunks/135-DW0z3QFH.js')),
			__memo(() => import('./chunks/136-CxfyigK9.js')),
			__memo(() => import('./chunks/137-DbBlUD2z.js')),
			__memo(() => import('./chunks/138-D6VTgC4a.js')),
			__memo(() => import('./chunks/139-BOdU6u96.js')),
			__memo(() => import('./chunks/140-BHKcRv8a.js')),
			__memo(() => import('./chunks/141-BICce8V4.js')),
			__memo(() => import('./chunks/142-Dc3Sa0qB.js')),
			__memo(() => import('./chunks/143-BZHb7jUF.js')),
			__memo(() => import('./chunks/144-DpA-QZS7.js')),
			__memo(() => import('./chunks/145-CqYn4kSo.js').then(function (n) { return n._; })),
			__memo(() => import('./chunks/146-B9NwxKFQ.js')),
			__memo(() => import('./chunks/147-BgCMEyFQ.js')),
		...
		routes: [
			...
			},
			{
				...
				endpoint: __memo(() => import('./chunks/_server.ts-DrVGeVV7.js'))
			},
			{
			...
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-TyhKsLNp.js'))
			},
			{
			...
			},
			{
				...
				endpoint: __memo(() => import('./chunks/_server.ts-odqKibJf.js'))
			},
			{
				...
				params: [{"name":"model","matcher":"urlmodel","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-QtfXim87.js'))
			},
			{
				...
				params: [{"name":"model","matcher":"urlmodel","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-Cab-UdfQ.js'))
			},
			{
			...
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-CUbCxml0.js'))
			},
			{
			...
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-B_Glap7Z.js'))
			}
		],
		...
		matchers: async () => {
			...
			const { match: filters } = await import ('./chunks/filters-D40qdu5O.js');
			const { match: fields } = await import ('./chunks/fields-DRSP5poI.js');
