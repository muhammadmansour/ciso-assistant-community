...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/27-CBusQVcK.js')),
			__memo(() => import('./chunks/28-C7KUbJ9H.js')),
			__memo(() => import('./chunks/29-C9Vptlnc.js')),
			__memo(() => import('./chunks/30-Hwjsk3LH.js')),
			__memo(() => import('./chunks/31-DB1jby60.js')),
			__memo(() => import('./chunks/32-CV4mmW53.js')),
			__memo(() => import('./chunks/33-DM5FzVPZ.js')),
			__memo(() => import('./chunks/34-5MEl8ue7.js')),
			__memo(() => import('./chunks/35-DuDmMomY.js')),
			__memo(() => import('./chunks/36-C3aDFXyz.js')),
			__memo(() => import('./chunks/37-C67PNZef.js')),
			__memo(() => import('./chunks/38-CIhpkClc.js')),
			__memo(() => import('./chunks/39-A1a00ubE.js')),
			__memo(() => import('./chunks/40-XgOtJmqC.js')),
			__memo(() => import('./chunks/41-CPyKGDWT.js')),
			__memo(() => import('./chunks/42-DtzJs63l.js')),
			__memo(() => import('./chunks/43-D1k6IGqB.js')),
			__memo(() => import('./chunks/44-CSx3EtjR.js')),
			__memo(() => import('./chunks/45-Cp_h-zTG.js')),
			__memo(() => import('./chunks/46-BCRkW6KB.js')),
			__memo(() => import('./chunks/47-CXAL5O1h.js')),
			__memo(() => import('./chunks/48-3-m9JH0z.js')),
			__memo(() => import('./chunks/49-2Ew_XniW.js')),
			__memo(() => import('./chunks/50-xTKUZrVj.js')),
			__memo(() => import('./chunks/51-BU0TdVSS.js')),
			__memo(() => import('./chunks/52-CreVldwj.js')),
			__memo(() => import('./chunks/53-D5g8vvfw.js')),
			__memo(() => import('./chunks/54-ComrjCZ_.js')),
			__memo(() => import('./chunks/55-BSc8KqSB.js')),
			__memo(() => import('./chunks/56-DjkSJdMD.js')),
			__memo(() => import('./chunks/57-Cm6rfwH0.js')),
			__memo(() => import('./chunks/58-t9Mp0Sec.js')),
			__memo(() => import('./chunks/59-uRix1pkv.js')),
			__memo(() => import('./chunks/60-TjDN0S1F.js')),
			__memo(() => import('./chunks/61-D3fk6CxU.js')),
			__memo(() => import('./chunks/62-DUzN_PPr.js')),
			__memo(() => import('./chunks/63-D-l164Nv.js')),
			__memo(() => import('./chunks/64-BV0ZmQRD.js')),
			__memo(() => import('./chunks/65-DHHr1rzR.js')),
			__memo(() => import('./chunks/66-DEOmZ1yD.js')),
			__memo(() => import('./chunks/67-NP6HmAaH.js')),
			__memo(() => import('./chunks/68-CEKINrgQ.js')),
			__memo(() => import('./chunks/69-DBNYaFqB.js')),
			__memo(() => import('./chunks/70-BPAdK3mq.js')),
			__memo(() => import('./chunks/71-rb-78N5Z.js')),
			__memo(() => import('./chunks/72-mmZxAwLc.js')),
			__memo(() => import('./chunks/73-B9JK4wTC.js')),
			__memo(() => import('./chunks/74-AfuC2wLH.js')),
			__memo(() => import('./chunks/75-yfCJYgik.js')),
			__memo(() => import('./chunks/76-SM5pPE23.js')),
			__memo(() => import('./chunks/77-Bo6ulGIf.js')),
			__memo(() => import('./chunks/78-BJ689rq7.js')),
			__memo(() => import('./chunks/79-qkcVAAVJ.js')),
			__memo(() => import('./chunks/80-DA4p7zCo.js')),
			__memo(() => import('./chunks/81-CdFv8lkE.js')),
			__memo(() => import('./chunks/82-D0Yrk27O.js')),
			__memo(() => import('./chunks/83-BbC7UUbk.js')),
			__memo(() => import('./chunks/84-mpN-H5de.js')),
			__memo(() => import('./chunks/85-D4K5zNCK.js')),
			__memo(() => import('./chunks/86-BEYi60gy.js')),
			__memo(() => import('./chunks/87-DsoAArdx.js')),
			__memo(() => import('./chunks/88-Mks8VNCP.js')),
			__memo(() => import('./chunks/89-Brc0amgo.js')),
			__memo(() => import('./chunks/90-rMX3xAKK.js')),
			__memo(() => import('./chunks/91-B77yCl61.js')),
			__memo(() => import('./chunks/92-BqGggbF6.js')),
			__memo(() => import('./chunks/93-pPMjACtu.js')),
			__memo(() => import('./chunks/94-q5xv7AIn.js')),
			__memo(() => import('./chunks/95-D7mmw-yz.js')),
			__memo(() => import('./chunks/96-DXyLmdQ-.js')),
			__memo(() => import('./chunks/97-CQLjhbZw.js')),
			__memo(() => import('./chunks/98-Bzd17pVa.js')),
			__memo(() => import('./chunks/99-BZcrvrsb.js')),
			__memo(() => import('./chunks/100-GnheaCWe.js')),
			__memo(() => import('./chunks/101-6K9mrsSU.js')),
			__memo(() => import('./chunks/102-C0w8Pdm_.js')),
			__memo(() => import('./chunks/103-BG90MIlN.js')),
			__memo(() => import('./chunks/104-CGaQBylM.js')),
			__memo(() => import('./chunks/105-BcEMurJS.js')),
			__memo(() => import('./chunks/106-CqpcFk2W.js')),
			__memo(() => import('./chunks/107-_7Mjm5ka.js')),
			__memo(() => import('./chunks/108-DL5BBtq0.js')),
			__memo(() => import('./chunks/109-XyoTwmMn.js')),
			__memo(() => import('./chunks/110-Bk52GJgD.js')),
			__memo(() => import('./chunks/111-DEpRVybq.js')),
			__memo(() => import('./chunks/112-BVOvNzdC.js')),
			__memo(() => import('./chunks/113-CnAUuJ7Z.js')),
			__memo(() => import('./chunks/114-C1EtTAnm.js')),
			__memo(() => import('./chunks/115-g3l8AXOb.js')),
			__memo(() => import('./chunks/116-BiY0G6_y.js')),
			__memo(() => import('./chunks/117-6bVu0xdU.js')),
			__memo(() => import('./chunks/118-DlACSbP9.js')),
			__memo(() => import('./chunks/119-RnNZP8qh.js')),
			__memo(() => import('./chunks/120-Pe3k6tJg.js')),
			__memo(() => import('./chunks/121-D4ZwTlyC.js')),
			__memo(() => import('./chunks/122-CjtJQiTM.js')),
			__memo(() => import('./chunks/123-55fjp_tH.js')),
			__memo(() => import('./chunks/124-ByPUkQOZ.js')),
			__memo(() => import('./chunks/125-qsF5g8nt.js')),
			__memo(() => import('./chunks/126-BTNi0QB1.js')),
			__memo(() => import('./chunks/127-DYZSXwav.js')),
			__memo(() => import('./chunks/128-Cc5WzQyN.js')),
			__memo(() => import('./chunks/129-CeRtYgH7.js')),
			__memo(() => import('./chunks/130-R31CTRCT.js')),
			__memo(() => import('./chunks/131-CdQJ_I2M.js')),
			__memo(() => import('./chunks/132-DyrTfNiT.js')),
			__memo(() => import('./chunks/133-0Fe1pDQu.js')),
			__memo(() => import('./chunks/134-swkcmUUY.js')),
			__memo(() => import('./chunks/135-CFWjJEAE.js')),
			__memo(() => import('./chunks/136-DAL286yA.js')),
			__memo(() => import('./chunks/137-CNiGDkuq.js')),
			__memo(() => import('./chunks/138-COKFcA_q.js')),
			__memo(() => import('./chunks/139-Dn-_hgT8.js')),
			__memo(() => import('./chunks/140-CRn3xfuN.js')),
			__memo(() => import('./chunks/141-DYH4P1uC.js')),
			__memo(() => import('./chunks/142-DI6cSo-l.js')),
			__memo(() => import('./chunks/143-H7Gwa7CF.js')),
			__memo(() => import('./chunks/144-BLdGJhO1.js')),
			__memo(() => import('./chunks/145-is9PA30A.js')),
			__memo(() => import('./chunks/146-I-nQET3O.js')),
			__memo(() => import('./chunks/147-DD0fBSqA.js')),
			__memo(() => import('./chunks/148-B4QQpZxf.js').then(function (n) { return n._; })),
			__memo(() => import('./chunks/149-CGxnk-57.js')),
			__memo(() => import('./chunks/150-CbDIsCde.js')),
			__memo(() => import('./chunks/151-D2ECNkMI.js')),
			__memo(() => import('./chunks/152-BEq4m8ZM.js'))
		],
		remotes: {
		...
		routes: [
			...
			},
			{
				...
				params: [{"name":"id","matcher":"uuid","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-8iIr-SCT.js'))
			},
			{
			...
			},
			{
				...
				params: [{"name":"id","matcher":"uuid","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-j0LmYnD-.js'))
			},
			{
