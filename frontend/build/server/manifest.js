...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/14-Bkw-UJ2W.js')),
			__memo(() => import('./chunks/15-_0ZQYc4W.js')),
			...
			__memo(() => import('./chunks/20-B8qvac0S.js')),
			__memo(() => import('./chunks/21-Bc6aDwe6.js')),
			__memo(() => import('./chunks/22-C1XsTOZl.js')),
			__memo(() => import('./chunks/23-DH0dX0zx.js')),
			__memo(() => import('./chunks/24-DKpau2HN.js')),
			__memo(() => import('./chunks/25-D7p0ZINp.js')),
			__memo(() => import('./chunks/26-AlDWfNjB.js')),
			__memo(() => import('./chunks/27-DsfZclEg.js')),
			__memo(() => import('./chunks/28-BhCCjQl_.js')),
			__memo(() => import('./chunks/29-Daw_seBI.js')),
			__memo(() => import('./chunks/30-Fskdj00L.js')),
			__memo(() => import('./chunks/31-CO8bOG2g.js')),
			__memo(() => import('./chunks/32-B1f5dDYB.js')),
			__memo(() => import('./chunks/33-C3tQnKVo.js')),
			__memo(() => import('./chunks/34-Bi-tr61q.js')),
			__memo(() => import('./chunks/35-DwG30jcH.js')),
			__memo(() => import('./chunks/36-DZ5ioEr_.js')),
			__memo(() => import('./chunks/37-Btr3DxbJ.js')),
			__memo(() => import('./chunks/38-l60DGdJm.js')),
			__memo(() => import('./chunks/39-BThdGkdk.js')),
			__memo(() => import('./chunks/40-ChdbJhQm.js')),
			__memo(() => import('./chunks/41-DJwUO5G6.js')),
			__memo(() => import('./chunks/42-DMfUhIAp.js')),
			__memo(() => import('./chunks/43-Bd7Ot2rA.js')),
			__memo(() => import('./chunks/44-D8oKoyzW.js')),
			__memo(() => import('./chunks/45-HmNV1XtA.js')),
			__memo(() => import('./chunks/46-RTabSB4E.js')),
			__memo(() => import('./chunks/47-Bq6m4SNG.js')),
			__memo(() => import('./chunks/48-n81NV39P.js')),
			__memo(() => import('./chunks/49-xbk0GL3X.js')),
			__memo(() => import('./chunks/50-DdAtrLXR.js')),
			__memo(() => import('./chunks/51-Rb2YqFn3.js')),
			__memo(() => import('./chunks/52-BXaOZTwy.js')),
			__memo(() => import('./chunks/53-zc6HwIAJ.js')),
			__memo(() => import('./chunks/54-BwVraDie.js')),
			__memo(() => import('./chunks/55-COhmIf7o.js')),
			__memo(() => import('./chunks/56-CDMZxLfh.js')),
			__memo(() => import('./chunks/57-B_dNg9xs.js')),
			__memo(() => import('./chunks/58-DFXUbYPX.js')),
			__memo(() => import('./chunks/59-BYHmEril.js')),
			__memo(() => import('./chunks/60-eDxSJuAL.js')),
			__memo(() => import('./chunks/61-BSDLcgf1.js')),
			__memo(() => import('./chunks/62-DtxVVHwN.js')),
			__memo(() => import('./chunks/63-BKYfNPBS.js')),
			__memo(() => import('./chunks/64-CizeyrUR.js')),
			__memo(() => import('./chunks/65-B997rZvV.js')),
			__memo(() => import('./chunks/66-2KrFQRu8.js')),
			__memo(() => import('./chunks/67-D-tqd8-J.js')),
			__memo(() => import('./chunks/68-D1m_9GHB.js')),
			__memo(() => import('./chunks/69-B8bDk9ky.js')),
			__memo(() => import('./chunks/70-BktP0IwA.js')),
			__memo(() => import('./chunks/71-Bu4w-YUI.js')),
			__memo(() => import('./chunks/72-ZRTonsUg.js')),
			__memo(() => import('./chunks/73-D-nPJzw7.js')),
			__memo(() => import('./chunks/74-ChMApfMj.js')),
			__memo(() => import('./chunks/75-B3WlSnnC.js')),
			__memo(() => import('./chunks/76-Bl7W4jcT.js')),
			__memo(() => import('./chunks/77-BguX3Kwb.js')),
			__memo(() => import('./chunks/78-DzXOZC5L.js')),
			__memo(() => import('./chunks/79-4wZPH101.js')),
			__memo(() => import('./chunks/80-CKhJynRl.js')),
			__memo(() => import('./chunks/81-CCK6BAkv.js')),
			__memo(() => import('./chunks/82-BwwHAHkK.js')),
			__memo(() => import('./chunks/83-B5oD3pA-.js')),
			__memo(() => import('./chunks/84-DK2oojq4.js')),
			__memo(() => import('./chunks/85-DwFG9SbN.js')),
			__memo(() => import('./chunks/86-Dy2cL_Ql.js')),
			__memo(() => import('./chunks/87-W5wEBcE8.js')),
			__memo(() => import('./chunks/88-CzXL95Lh.js')),
			__memo(() => import('./chunks/89-BJm2lfvo.js')),
			__memo(() => import('./chunks/90-CzFwusSI.js')),
			__memo(() => import('./chunks/91-CWIQiUMr.js')),
			__memo(() => import('./chunks/92-BaaURQ4n.js')),
			__memo(() => import('./chunks/93-C23SHUck.js')),
			__memo(() => import('./chunks/94-CFpvV98-.js')),
			__memo(() => import('./chunks/95-9qHdJmHX.js')),
			__memo(() => import('./chunks/96-BaMqT-oC.js')),
			__memo(() => import('./chunks/97-CGenOaAA.js')),
			__memo(() => import('./chunks/98-qEmsiJCk.js')),
			__memo(() => import('./chunks/99-DI1t2-Oe.js')),
			__memo(() => import('./chunks/100-CNK4nEtA.js')),
			__memo(() => import('./chunks/101-DnSFY-d7.js')),
			__memo(() => import('./chunks/102-D_NMf08e.js')),
			__memo(() => import('./chunks/103-ByLbJJJs.js')),
			__memo(() => import('./chunks/104-Ch9cl4Ze.js')),
			__memo(() => import('./chunks/105-CgEy6ZvM.js')),
			__memo(() => import('./chunks/106-KWWM89XX.js')),
			__memo(() => import('./chunks/107-COIpYXiJ.js')),
			__memo(() => import('./chunks/108-98dqD5NR.js')),
			__memo(() => import('./chunks/109-BlgWF2fQ.js')),
			__memo(() => import('./chunks/110-BtcuARFP.js')),
			__memo(() => import('./chunks/111-OeRFsh-Q.js')),
			__memo(() => import('./chunks/112-CHsC-fK6.js')),
			__memo(() => import('./chunks/113-D_wVgs6W.js')),
			__memo(() => import('./chunks/114-DMd8TDqJ.js')),
			__memo(() => import('./chunks/115-D0v-S5P4.js')),
			__memo(() => import('./chunks/116-DKNtzGwc.js')),
			__memo(() => import('./chunks/117-Bw6eGWNY.js')),
			__memo(() => import('./chunks/118-XkVOS6bG.js')),
			__memo(() => import('./chunks/119-DIL4MkIz.js')),
			__memo(() => import('./chunks/120-DHjLvcay.js')),
			__memo(() => import('./chunks/121-CA8NNr-X.js')),
			__memo(() => import('./chunks/122-CV9OVepn.js')),
			__memo(() => import('./chunks/123-BZWKjeTE.js')),
			__memo(() => import('./chunks/124-BO3_zWzC.js')),
			__memo(() => import('./chunks/125-BQae6dTF.js')),
			__memo(() => import('./chunks/126-BX8aI18q.js')),
			__memo(() => import('./chunks/127-kov7_SRr.js')),
			__memo(() => import('./chunks/128-B1aMSiqd.js')),
			__memo(() => import('./chunks/129-CzTzhUxY.js')),
			__memo(() => import('./chunks/130-ZQeQeWyC.js')),
			__memo(() => import('./chunks/131-nZia_e1k.js')),
			__memo(() => import('./chunks/132-C3WQ4Vib.js')),
			__memo(() => import('./chunks/133-DAPV-neA.js')),
			__memo(() => import('./chunks/134-gqvqgHmE.js')),
			__memo(() => import('./chunks/135-wSArQ9iI.js')),
			__memo(() => import('./chunks/136-CsAh7uw4.js')),
			__memo(() => import('./chunks/137-wx0TZGTp.js')),
			__memo(() => import('./chunks/138-BsxLKTBm.js')),
			__memo(() => import('./chunks/139-dsr285Kh.js')),
			__memo(() => import('./chunks/140-C3Y-mNPO.js')),
			__memo(() => import('./chunks/141-CEiIvtMD.js')),
			__memo(() => import('./chunks/142-ITMcwhe7.js')),
			__memo(() => import('./chunks/143-BtSqZcm7.js')),
			__memo(() => import('./chunks/144-BDQq5QpB.js')),
			__memo(() => import('./chunks/145-ByYHCMYI.js').then(function (n) { return n._; })),
			__memo(() => import('./chunks/146-gMDyPkOR.js')),
			__memo(() => import('./chunks/147-DaUyFyog.js')),
		...
		routes: [
			...
			},
			{
				...
				endpoint: __memo(() => import('./chunks/_server.ts-WDJvzYoP.js'))
			},
			{
			...
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-w7t5Kvka.js'))
			},
			{
			...
			},
			{
				...
				endpoint: __memo(() => import('./chunks/_server.ts-y4ATPce6.js'))
			},
			{
				...
				params: [{"name":"model","matcher":"urlmodel","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-YcnHlX6-.js'))
			},
			{
				...
				params: [{"name":"model","matcher":"urlmodel","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-DTygJmvS.js'))
			},
			{
			...
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-DxeAvFEZ.js'))
			},
			{
			...
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-6islpUsg.js'))
			}
		],
		...
		matchers: async () => {
			...
			const { match: filters } = await import ('./chunks/filters-Dj3Y8rXn.js');
			const { match: fields } = await import ('./chunks/fields-CmK_HVOI.js');
