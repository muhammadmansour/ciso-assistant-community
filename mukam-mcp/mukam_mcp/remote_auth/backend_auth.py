"""Log the user into Muhkam and mint a Personal Access Token."""
...
def login_and_mint_pat(email: str, password: str, token_name: str) -> str:
    ...
    try:
        ...
        raise BackendAuthError("Could not reach the Muhkam API. Please try again.")
    ...
    if pat_res.status_code not in (200, 201):
        raise BackendAuthError(
            ...
            "remove an old one from your Muhkam profile settings and try again."
        )
